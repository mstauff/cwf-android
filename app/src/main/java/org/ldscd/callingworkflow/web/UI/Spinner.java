package org.ldscd.callingworkflow.web.UI;
...
public class Spinner {
    ...
    public static void showProgress(final boolean show, final View mFormView, final View mProgressView, Resources resources) {
